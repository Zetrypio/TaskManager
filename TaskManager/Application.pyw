...
def main():
    ...
    periodeSemaine = app.getPeriodManager().ajouter(app.getPeriodManager(), Periode("semaine", datetime.date(2020, 5, 4), datetime.date(2020, 5, 27), "semaine pour faciliter les calculs",color = "#7FFF7F"))
