...
def askEditTask(task):
   ...
   #varCouleur.set(task.getColor())
    ...
    sbJour = Spinbox(          frameDuree, from_ = 0, to=31, increment = 1, width = 4, command = autoSetFin, textvariable = varJour)
    lbJour = Label(            frameDuree, text = "jours")
    sbHour = Spinbox(          frameDuree, from_ = 0, to=23, increment = 1, width = 4, command = autoSetFin, textvariable = varHour)
    lbHour = Label(            frameDuree, text = "heures")
    sbMin = Spinbox(           frameDuree, from_ = 0, to=59, increment = 1, width = 4, command = autoSetFin, textvariable = varMin)
