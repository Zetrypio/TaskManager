...
class TaskParametre(AbstractSchedulableParametre):
    ...
    def __init__(self, master, task, **kw):
        ...
        self.lbListDepces = Listbox( self._frameAdvanced, listvariable = self.__getListTask(self.getSchedulable().getDependances(), StringV = True), selectmode = "single", height = len(self.__getListTask(self.getSchedulable().getDependances(), StringV = True).get().split("\\")))
        ...
        self.lbListDeptes = Listbox( self._frameAdvanced, listvariable = self.__getListTask(self.getSchedulable().getDependantes(), StringV = True), selectmode = "single", height = len(self.__getListTask(self.getSchedulable().getDependantes(), StringV = True).get().split("\\")))
