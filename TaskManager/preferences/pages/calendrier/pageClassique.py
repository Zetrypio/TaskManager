...
class PageClassique(AbstractPage):
    def __init__(self, master, **kwargs):
        ...
        self._listData.append([self.__varHeureDebut, "Heure de début"])
        ...
        self._listData.append([self.__varHeureFin, "Heure de fin"])
        ...
        # Initialisation
        self.__varHeureDebut.set("8:00")
        self.__varHeureFin.set("18:59")
