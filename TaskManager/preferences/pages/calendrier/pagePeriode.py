...
class PagePeriode(AbstractPage):
    def __init__(self, master, **kwargs):
         ...
         # Note : Si on rajoute une option ne pas oublier d'ajouter la variable de controle à self._listData.append([variable, "texte explicatif", valeurParDéfaut])
        ...
        self._listData.append([self.__varJour, "Jour de début de semaine", "Lund"])
