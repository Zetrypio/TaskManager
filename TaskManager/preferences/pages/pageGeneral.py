...
class PageGeneral(AbstractPage):
    def __init__(self, master, **kwargs):
        ...
        self.__caseChargerPeriode = Checkbutton(self._mFrame, text = "Charger la dernière période utilisé", variable = self.__varChargerLastPeriode)


        # Affichage
        self.__horlogeLabelFrame.grid(column = 0, row = 0, sticky="NWES")
        self.__caseTypeHorloge.pack(side = TOP, expand = NO, fill = X)
        self.__caseChargerPeriode.grid(row = 1, column = 0, sticky = "nsew")
